...
describe('Custom Tests', function () {
  ...
  it('[assignment] ii. deposit 0.1 ETH in L1 -> withdraw 0.08 ETH in L2 -> assert balances', async () => {
      ...
      const { tornadoPool, token, omniBridge, merkleTree } = await loadFixture(fixture)
  ...
  it('[assignment] iii. see assignment doc for details', async () => {
      // [assignment] complete code here
      const { tornadoPool, token, proxy, omniBridge, amb, gov, multisig } = await loadFixture(fixture)
     ...
     ///////////////////////////////////////////
      ...
      expect(await token.balanceOf(bobAddress)).to.be.equal(utils.parseEther("0.06"), "Bob didn't recieved his money");
       ///////////////////////////////////////////
     ...
     ///////////////////////////////////////////
      // How much alice still have
      // console.log(aliceChangeUtxo.amount)
      // console.log(await token.balanceOf(bobEthAddress))
      // console.log(bobChangeUtxo.amount)
      // console.log(aliceDepositUtxo.amount)
      // How much bob now have
      // Bob on bridge has zero wealth
  })
})
